...
{
       0,     0,     3,     4,     8,    12,    14,    18,    22,    26,
      30,    34,    38,    42,    46,    50,    53,    55,    57,    59
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      18,     0,    -1,    -1,    18,    19,    13,    -1,    18,     1,
      13,    -1,    20,    -1,     4,    14,    20,    -1,    15,    20,
      16,    -1,    20,     9,    20,    -1,    20,    10,    20,    -1,
      20,    11,    20,    -1,    20,     7,    20,    -1,    20,     8,
      20,    -1,    20,     6,    20,    -1,    20,     5,    20,    -1,
       8,    20,    -1,     4,    -1,    21,    -1,     3,    -1,    21,
       3,    -1
};
...
{
       0,    22,    22,    24,    26,    31,    36,    41,    46,    51,
      56,    61,    66,    71,    76,    81,    86,    91,    93,    98
};
#endif
...
#line 32 "calc.yacc"
    {
           printf("%d\n",(yyvsp[(1) - (1)]));   /* print expression with newline */ 
         }
    break;
...
#line 37 "calc.yacc"
    {
           regs[(yyvsp[(1) - (3)])] = (yyvsp[(3) - (3)]);	/* store the LETTER index with the content of expr */
         }
    break;
...
#line 42 "calc.yacc"
    {
           (yyval) = (yyvsp[(2) - (3)]);		/* content of the array regs[LETTER] ($$) = expr */
         }
    break;
...
#line 47 "calc.yacc"
    {
           (yyval) = (yyvsp[(1) - (3)]) * (yyvsp[(3) - (3)]);	/* store product in the content in regs[LETTER] = $$ */
         }
    break;
...
#line 82 "calc.yacc"
    {
           (yyval) = -(yyvsp[(2) - (2)]);		/* value is negative */
         }
    break;
...
#line 87 "calc.yacc"
    {
           (yyval) = regs[(yyvsp[(1) - (1)])];	/* the content in regs[LETTER] = LETTER */
         }
    break;
...
#line 94 "calc.yacc"
    {
           (yyval) = (yyvsp[(1) - (1)]);		/* first digit */
           base = ((yyvsp[(1) - (1)])==0) ? 8 : 10;	/* check for base ie: if $1=0, then octal; else decimal */
         }
    break;
...
#line 99 "calc.yacc"
    {
           (yyval) = base * (yyvsp[(1) - (2)]) + (yyvsp[(2) - (2)]);	/* base is global set 8 or 10 */
         }
    break;
